  ...
  return (
    <>
      ...
      >
        ...
        >
          <div className="flex flex-none items-center justify-between gap-2 px-4 pt-4 pb-2">
            <div className="min-w-0 flex-1">
              {top ?? (
                <div className="flex items-center gap-2">
                  <img src="/logo.png" alt="Gebook logo" className="size-6 rounded-md object-contain ring-1 ring-border/40" />
