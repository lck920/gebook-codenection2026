...
const OTP_COPY: Record<EmailLocale, Record<OtpEmailType, OtpEmailCopy>> = {
  en: {
    "sign-in": {
      subject: "Your Gebook sign-in code",
      heading: "Your sign-in code",
      intro: "Use this code to finish signing in to Gebook.",
      expiry: (m) => `It expires in ${m} minute${m === 1 ? "" : "s"}.`,
      ignore: "If you did not request this, you can ignore this email.",
    },
    "email-verification": {
      subject: "Verify your Gebook email",
      heading: "Verify your email",
      intro: "Enter this code to verify your Gebook account.",
      expiry: (m) => `It expires in ${m} minute${m === 1 ? "" : "s"}.`,
      ignore: "If you did not request this, you can ignore this email.",
    },
    "forget-password": {
      subject: "Reset your Gebook password",
    ...
    "change-email": {
      subject: "Confirm your new Gebook email",
  ...
  zh: {
    "sign-in": {
      subject: "你的 Gebook 登录验证码",
      heading: "登录验证码",
      intro: "请使用以下验证码完成 Gebook 登录。",
      expiry: (m) => `验证码将在 ${m} 分钟后失效。`,
      ignore: "如果这不是你本人的操作，可以忽略这封邮件。",
    },
    "email-verification": {
      subject: "验证你的 Gebook 邮箱",
      heading: "验证邮箱",
      intro: "请输入以下验证码，以完成 Gebook 账号邮箱验证。",
      expiry: (m) => `验证码将在 ${m} 分钟后失效。`,
      ignore: "如果这不是你本人的操作，可以忽略这封邮件。",
    },
    "forget-password": {
      subject: "重置你的 Gebook 密码",
      heading: "重置密码",
...
const LINK_COPY: Record<EmailLocale, Record<LinkEmailType, LinkEmailCopy>> = {
  en: {
    "reset-password": {
      ...
      heading: "Reset your password",
      intro:
        "Use the button below to set a new password for your Gebook account.",
    ...
    "change-email-confirmation": {
      subject: "Confirm your Gebook email change",
      heading: "Confirm your email change",
      intro:
        "Confirm that you want to change the email on your Gebook account.",
  ...
  zh: {
    "reset-password": {
      subject: "重置你的 Gebook 密码",
      heading: "重置密码",
      intro: "点击下方按钮，为你的 Gebook 账号设置新密码。",
      button: "重置密码",
      orOpenLink: "或打开此链接：",
      ignore: "如果这不是你本人的操作，可以忽略这封邮件。",
      detail: (value) => value,
    ...
    "change-email-confirmation": {
      subject: "确认修改 Gebook 邮箱",
      heading: "确认修改邮箱",
      intro: "请确认你要更改 Gebook 账号绑定的邮箱。",
      button: "确认修改邮箱",
      orOpenLink: "或打开此链接：",
      ignore: "如果这不是你本人的操作，可以忽略这封邮件。",
